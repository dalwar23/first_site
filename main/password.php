<?php
	...
	{ header("Location:mverify.php?flg=orange"); exit;}
...
<div id="page">
	...
	<!--		<h2 class="title">Welcome to Abundant</h2>
			...
			<div class="entry">
						...
						<tr>
						<td colspan='7'>
						These password will tell you the truth.Hope you will find these helpful.
						</td>
						</tr>
                                                    <tr style='color:black;'>
														...
														<th align='center'>Direct Link</th>
                                                    </tr>
                                                " ;
							...
							<td> <a href='$siteurl'>Click Me</a></td>
                                                ...
                                                echo "
                                                <tr>
                                                    <td  colspan='7' align='center'>Total : $rows &nbsp; Passwords!</td>
                                                </tr>
                                                ";
                ...
                <h2 align="center"> >> <a href="mverify.php?flg=offwhite">Sign Out</a> << </h2>
		</div>
