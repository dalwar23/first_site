<?php
	...
	switch ($flg) {
		...
		case "darkgray":
			...
			break;
		case "orange":
			$error = "You must enter encryption code to enter the Reading page!" ;
			break;
		case "offwhite":
			$error = "You are signed out from the Reading page!" ;
			break;
		default:
			$error = "             ";
	}
...
<div id="wrapper">
	...
	<div id="logo">
		<!-- here goes the table -->
        <br/>
        <h3 align="center" style="font-size:50px; color:white;">anwar! are you here?</h3>
        <br />

   <form action="averify_process.php" method="post" >
        <table align="center" border="0px" width="50%" cellspacing="25px" cellpadding="10px">
            ...
            <tr>
            	<td align="center" colspan="2">
                	<input type="submit" name="submit" value="Read" style="font-size:14px; font-weight:bold; text-transform:uppercase;" />                </td>
            </tr>
        </table>
     </form>
	</div>
